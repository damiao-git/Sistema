    ...
    public class SeedingService
        ...
        public void Seed()
            ...
            if(_context.Department.Any() || _context.Seller.Any() || _context.SalesRecords.Any())
                {
                return; //Banco já alimentado
                }
            Department d1 = new Department(1, "Carros");
            Department d2 = new Department(2, "Motos");
            Department d3 = new Department(3, "Bicicletas");

            Seller s1 = new Seller(1, "Damião", "damiao@gmail.com", new DateTime(1996, 11, 25), 1720.0, d1);
            Seller s2 = new Seller(2, "Allyne", "allyne@gmail.com", new DateTime(2002,04,16), 2000.0, d2);
            Seller s3 = new Seller(3, "Ana", "ana@gmail.com", new DateTime(1996 , 11 , 24), 1220.0, d3);
            ...
            SalesRecord r9 = new SalesRecord(9, new DateTime(2018, 09, 14), 11000.0, SaleStatus.Pending, s2);
            SalesRecord r10 = new SalesRecord(10, new DateTime(2018, 09, 7), 9000.0, SaleStatus.Billed, s3);
            ...
            SalesRecord r20 = new SalesRecord(20, new DateTime(2018, 10, 15), 8000.0, SaleStatus.Billed, s2);
            SalesRecord r21 = new SalesRecord(21, new DateTime(2018, 10, 17), 9000.0, SaleStatus.Billed, s2);
            SalesRecord r22 = new SalesRecord(22, new DateTime(2018, 10, 24), 4000.0, SaleStatus.Billed, s3);
            SalesRecord r23 = new SalesRecord(23, new DateTime(2018, 10, 19), 11000.0, SaleStatus.Canceled, s2);
            SalesRecord r24 = new SalesRecord(24, new DateTime(2018, 10, 12), 8000.0, SaleStatus.Billed, s3);
            SalesRecord r25 = new SalesRecord(25, new DateTime(2018, 10, 31), 7000.0, SaleStatus.Billed, s3);
            SalesRecord r26 = new SalesRecord(26, new DateTime(2018, 10, 6), 5000.0, SaleStatus.Billed, s3);
            ...
            SalesRecord r29 = new SalesRecord(29, new DateTime(2018, 10, 23), 12000.0, SaleStatus.Billed, s1);
